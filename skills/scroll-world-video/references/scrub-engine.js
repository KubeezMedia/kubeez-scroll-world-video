/* ============================================================================
   scroll-world-video (Kubeez) — portable scroll-scrubbed camera-flight engine
   ----------------------------------------------------------------------------
...
function mountKubeezWorld(container, config) {
...
if (typeof module !== 'undefined' && module.exports) module.exports = { mountKubeezWorld };
if (typeof window !== 'undefined') window.mountKubeezWorld = mountKubeezWorld;
